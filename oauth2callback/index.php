...
echo '<br><br>';
$token = htmlspecialchars($responseObj->access_token);
echo "OAuth2 server provided access token: <code id='tok'>" . $token . "</code> ";
echo "<button onclick=\"navigator.clipboard.writeText(document.getElementById('tok').innerText)\">Copy</button>";
}
